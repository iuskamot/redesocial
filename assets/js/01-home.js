...
/* GERENCIAR > SHORTS (admin, ver assets/js/19-gerenciar-shorts.js): cada unidade ganhou
...
/* GERENCIAR > SHORTS (admin, ver assets/js/19-gerenciar-shorts.js): dados extras só para a
...
function matchReel(r){
  ...
  /* GERENCIAR > SHORTS (admin, ver assets/js/19-gerenciar-shorts.js): filtros extras da tela de
...
function foBuildReelFilters(){
  ...
  /* GERENCIAR > SHORTS (admin): sidebar de filtro avançado, implementada à parte em
     assets/js/19-gerenciar-shorts.js (foBuildGerenciarShortsFilters) — o ramo social/grade
...
function renderGrid(){
  ...
  /* GERENCIAR > SHORTS (admin): tabela de gerenciamento, implementada à parte em
     assets/js/19-gerenciar-shorts.js (renderGerenciarShortsList) para não misturar com a grade/feed
