/* =====================================================================
   GERENCIAR > PUBLICAÇÕES (admin) — assets/js/20-gerenciar-publicacoes.js
   ...
   irmã de Shorts (assets/js/19-gerenciar-shorts.js) — mesma sidebar de
   ...
   Reaproveita, por referência (sem duplicar), helpers já existentes:
     ...
     - assets/js/19-gerenciar-shorts.js: sbUnitObjFor, RX_REACH_LABEL, rxSchedShort,
...
/* Núcleo da tabela de gerenciamento — colunas ID, Publicação (+ menu de Ações), Situação, Data
   ...
   de renderGerenciarShortsList (19-gerenciar-shorts.js). */
